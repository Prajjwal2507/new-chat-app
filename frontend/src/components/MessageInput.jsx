    ...
    <div className="p-2 sm:p-4 border-t border-slate-700/50">
      ...
      <form onSubmit={handleSendMessage} className="max-w-3xl mx-auto flex gap-2 sm:gap-4">
        <input
          ...
          className="flex-1 bg-slate-800/50 border border-slate-700/50 rounded-lg py-2 px-3 sm:px-4 text-sm sm:text-base text-slate-200 placeholder:text-slate-500 focus:outline-none focus:border-cyan-500/50"
